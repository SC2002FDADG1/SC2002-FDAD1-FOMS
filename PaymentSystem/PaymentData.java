...
public class PaymentData implements ReadFile, Save, Write, ReadObject
{
    ...
    public static void main(String[] aArgs) throws IOException  
    {
		...
		try {
			...
			ArrayList al = txtDB.readObject(filename) ;
			for (int i = 0 ; i < al.size() ; i++) {
					PaymentType payment = (PaymentType)al.get(i);
					System.out.println("Name " + payment.getNameOfPayment() );
					System.out.println("Availability " + payment.getAvailabilityOfPayment() );
			}
			/*PaymentType p1 = new PaymentType("Dung" , Payment_Availability.UN_USED );
                        PaymentType payment1 = new PaymentType("Credit Card");
                        PaymentType payment2 = new PaymentType("Debit Card");
                        PaymentType payment3 = new PaymentType("PayPal");
                        PaymentType payment4 = new PaymentType("Bank Transfer");
                        PaymentType payment5 = new PaymentType("Bitcoin");
			...
			al.add(p1);*/
                        ...
                        al.remove(3) ; // remove Bank Transfer
			// write Professor record/s to file.
			txtDB.save(filename, al);
		}catch (IOException e) {
